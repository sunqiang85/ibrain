...
if rot<180
%     th=text(b,repmat(c(1)-1.5*(c(2)-c(1)),length(b),1),a,'HorizontalAlignment','right','rotation',rot,'VerticalAlignment','bottom');
    th=text(b,repmat(c(1)-1.5*(c(2)-c(1)),length(b),1),a,'HorizontalAlignment','right','rotation',rot);
else
